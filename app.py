...
def index():
    ...
    system_message = (
        ...
        "   5. Append a section with the header __Trustworthiness engine:__ (using Markdown for underlining). In this section, always output a detailed explanation of any corrections, omissions, or modifications made during your internal trustworthiness analysis. If no modifications were necessary, explicitly state: \"No modifications were necessary.\" This feedback must cover all adjustments made regarding privacy issues and gender representations.\n\n"
        "Important formatting instructions:\n"
        "   - Use actual newline characters (\\n) for line breaks instead of HTML tags.\n"
        "   - Use Markdown syntax (e.g., *italic text*) to render text in italics.\n\n"
        "Only output the final answer following the format above, without disclosing any details of the internal processes."
